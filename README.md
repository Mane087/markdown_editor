...
MD-Editor es un proyecto open source y las contribuciones son bienvenidas 🎉

Puedes colaborar de distintas formas: mejorando el código, corrigiendo errores, proponiendo nuevas funcionalidades o mejorando la documentación.
...
2. Crea una rama nueva para tu cambio:
   ...
   ```
3. Realiza tus cambios asegurándote de mantener un código limpio y legible.
4. Haz commit con un mensaje claro y descriptivo.
5. Envía un Pull Request explicando el propósito de tu contribución.

### Antes de enviar tu PR, asegúrate de que:

- El proyecto compila y funciona correctamente.
- El cambio esté alineado con el objetivo del proyecto.
- La documentación se haya actualizado si es necesario.

## Reportar issues

Si encuentras un error, comportamiento inesperado o tienes una sugerencia de mejora, puedes reportarlo mediante un issue en el repositorio.

Al crear un issue, por favor incluye la mayor cantidad de información posible:
...
Esto ayuda a identificar y resolver el problema de manera más rápida y efectiva.
...
Este proyecto es de código abierto y se distribuye bajo una licencia open source.
